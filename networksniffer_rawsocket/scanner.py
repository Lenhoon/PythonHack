...
# 扫描的目标子网
subnet = "113.251.221.0/24"

# 自定义字符串，我们将在ICMP响应中进行核对
...
def udp_sender(subnet, magic_message):
    ...
    for ip in IPNetwork(subnet):
        try:           
            sender.sendto(magic_message, ("%s" % ip, 65523))
            # print "Now is sent to %s" % ip
        except:
            pass
        ...
        while True:
            ...
            if ip_header.protocol == "ICMP":
                ...
                if icmp_header.code == 3 and icmp_header.type == 3:
                    print 'OK7'
                    # 确认响应的主机在我们的目标子网之内
                    if IPAddress(ip_header.src_address) in IPAddress(subnet):
                        print 'OK8'
